...
class TableViewController: UITableViewController {
    var datos: [String] = [ "Jesús", "Andrés", "Daniel", "Allan", "Aracely", "Iliana", "Fernando", "Fanny" ]
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "passName" {
            let singleContact: SingleContactViewController = segue.destinationViewController as! SingleContactViewController

            let indexPath: NSIndexPath
            if let tableView = self.tableView {
                indexPath = tableView.indexPathForSelectedRow!
                singleContact.n = self.datos[ indexPath.row ]
            }
        }
    }
